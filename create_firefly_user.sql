...
-- Create user
INSERT INTO users (created_at, updated_at, email, email_verified_at, password, blocked, blocked_code) 
VALUES (NOW(), NOW(), 'bbayarbileg@gmail.com', NOW(), '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 0, NULL);
